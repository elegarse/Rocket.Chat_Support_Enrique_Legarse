...
export declare const getPositionStyle: ({ placement, container, targetBoundaries, variantStore, target }: {
    placement: Placements;
    target: DOMRect;
    container: DOMRect;
 ...
 * @public
 */
export declare const usePosition: (reference: RefObject<Element>, target: RefObject<Element>, options: PositionOptions) => PositionResult;
export {};
